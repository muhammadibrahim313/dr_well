<<<<<<< HEAD
# dr_well
Dr. Well is an AI-powered health dashboard built with Streamlit. Track your vital health metrics, schedule appointments, and receive personalized medical advice from AI.
=======
<<<<<<< HEAD
# dr_well
Dr. Well is an AI-powered health dashboard built with Streamlit. Track your vital health metrics, schedule appointments, and receive personalized medical advice from AI.
...
>>>>>>> b9b7694 (initial commit)
>>>>>>> a40f495 (initial commit)
